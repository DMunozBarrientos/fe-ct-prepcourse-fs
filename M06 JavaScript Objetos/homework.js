...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var persona = {nombre: nombre , edad : edad , meow : () => {return  "Meow!"}}
   return persona
}
...
function tieneEmail(objetoUsuario) {
   ...
   if (resultado === true && objetoUsuario['email'] === null) resultado = false
   return resultado
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   var resultado = objeto.hasOwnProperty(propiedad)
   return resultado
}
...
function verificarPassword(objetoUsuario, password) {
   ...
   // Tu código:
   resultado = false
   if (objetoUsuario['password'] === password) resultado = true
   return resultado
}
